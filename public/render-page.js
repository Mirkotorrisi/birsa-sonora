...
var http = __webpack_require__(2066);
var https = __webpack_require__(4536);
...
var _react = _interopRequireDefault(__webpack_require__(8237));
...
var React = _interopRequireWildcard(__webpack_require__(8237));
...
var _react = __webpack_require__(8237);
...
const preferDefault=m=>m&&m.default||m;exports.components={"component---src-pages-blog-js":preferDefault(__webpack_require__(223)),"component---src-pages-index-js":preferDefault(__webpack_require__(8745)),"component---src-templates-blog-post-js":preferDefault(__webpack_require__(4805))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-image',plugin:__webpack_require__(573),options:{"plugins":[]}},{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(9814),options:{"plugins":[]}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(6313),options:{"plugins":[],"output":"/sitemap","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'gatsby-plugin-next-seo',plugin:__webpack_require__(4613),options:{"plugins":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(341),options:{"plugins":[],"icon":"src/images/logo_brisa.webp","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"cbfdb2c424d74ee96dd298f021afb7a3"}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8237);
...
// EXTERNAL MODULE: external "C:\\Users\\Mirko\\Documents\\brisa-sonora\\node_modules\\react\\index.js"
var external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_ = __webpack_require__(8237);
var external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_);
...
const prefetchPathname=loader.enqueue;const StaticQueryContext=/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createContext({});function StaticQueryDataRenderer({staticQueryData,data,query,render}){const finalData=data?data.data:staticQueryData[query]&&staticQueryData[query].data;return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement((external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default()).Fragment,null,finalData&&render(finalData),!finalData&&/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",null,"Loading (StaticQuery)"));}const StaticQuery=props=>{const{data,query,render,children}=props;return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(StaticQueryContext.Consumer,null,staticQueryData=>/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(StaticQueryDataRenderer,{data:data,query:query,render:render||children,staticQueryData:staticQueryData}));};const useStaticQuery=query=>{var _context$query;if(typeof (external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default()).useContext!==`function`&&"production"===`development`){}const context=external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().useContext(StaticQueryContext);// query is a stringified number like `3303882` when wrapped with graphql, If a user forgets
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);var React=_interopRequireWildcard(__webpack_require__(8237));var _gatsby=__webpack_require__(2031);var _common=__webpack_require__(8108);var _getManifestPathname=_interopRequireDefault(__webpack_require__(1632));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "wrapRootElement": () => (/* reexport safe */ _lib_gatsby_ssr__WEBPACK_IMPORTED_MODULE_0__.op),
/* harmony export */   "wrapPageElement": () => (/* reexport safe */ _lib_gatsby_ssr__WEBPACK_IMPORTED_MODULE_0__.hQ),
/* harmony export */   "onRenderBody": () => (/* reexport safe */ _lib_gatsby_ssr__WEBPACK_IMPORTED_MODULE_0__.s9)
/* harmony export */ });
/* harmony import */ var _lib_gatsby_ssr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9316);
...
"use strict";
var __webpack_unused_export__;
var _interopRequireDefault=__webpack_require__(5318);__webpack_unused_export__ = ({value:true});exports.op=exports.hQ=exports.s9=void 0;var _extends2=_interopRequireDefault(__webpack_require__(7154));var _react=_interopRequireDefault(__webpack_require__(8237));var _reactHelmetAsync=__webpack_require__(405);var _baseSeo=__webpack_require__(9777);var _ssrContext=__webpack_require__(9361);var onRenderBody=function onRenderBody(_ref){var setHeadComponents=_ref.setHeadComponents,setHtmlAttributes=_ref.setHtmlAttributes,setBodyAttributes=_ref.setBodyAttributes;var filledContext=(0,_ssrContext.getFilledContext)();if(!filledContext){return;}var helmet=filledContext.helmet;if(setHtmlAttributes){setHtmlAttributes(helmet.htmlAttributes.toComponent());}if(setBodyAttributes){setBodyAttributes(helmet.bodyAttributes.toComponent());}setHeadComponents([helmet.title.toComponent(),helmet.link.toComponent(),helmet.meta.toComponent(),helmet.noscript.toComponent(),helmet.script.toComponent(),helmet.style.toComponent(),helmet.base.toComponent()]);};exports.s9=onRenderBody;var wrapPageElement=function wrapPageElement(_ref2,options){var element=_ref2.element;return/*#__PURE__*/_react["default"].createElement(_react["default"].Fragment,null,/*#__PURE__*/_react["default"].createElement(_baseSeo.BaseSeo,(0,_extends2["default"])({},options,{defer:false})),element);};exports.hQ=wrapPageElement;var wrapRootElement=function wrapRootElement(_ref3){var element=_ref3.element;return/*#__PURE__*/_react["default"].createElement(_reactHelmetAsync.HelmetProvider,{context:_ssrContext.emptyContext},element);};exports.op=wrapRootElement;
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));var _meta=__webpack_require__(1008);Object.keys(_meta).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _meta[key];}});});var _jsonld=__webpack_require__(6855);Object.keys(_jsonld).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _jsonld[key];}});});var _types=__webpack_require__(5453);Object.keys(_types).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _types[key];}});});
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.NewsArticleJsonLd=exports.BlogPostJsonLd=exports.ArticleJsonLd=void 0;var _extends2=_interopRequireDefault(__webpack_require__(7154));var _objectWithoutProperties2=_interopRequireDefault(__webpack_require__(6479));var _defineProperty2=_interopRequireDefault(__webpack_require__(9713));var _react=_interopRequireDefault(__webpack_require__(8237));var _jsonld=__webpack_require__(7829);function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}/**
 ...
 */var ArticleJsonLd=function ArticleJsonLd(_ref){var url=_ref.url,headline=_ref.headline,title=_ref.title,_ref$images=_ref.images,images=_ref$images===void 0?[]:_ref$images,datePublished=_ref.datePublished,dateCreated=_ref.dateCreated,_ref$dateModified=_ref.dateModified,dateModified=_ref$dateModified===void 0?datePublished:_ref$dateModified,_ref$authorType=_ref.authorType,authorType=_ref$authorType===void 0?'Person':_ref$authorType,authorName=_ref.authorName,description=_ref.description,publisherName=_ref.publisherName,publisherLogo=_ref.publisherLogo,body=_ref.body,overrides=_ref.overrides,keywords=_ref.keywords,speakable=_ref.speakable,_ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer;var json=_objectSpread({'@context':'https://schema.org','@type':'Article',mainEntityOfPage:{'@type':'WebPage','@id':url},headline:headline!==null&&headline!==void 0?headline:title,image:images,datePublished:datePublished,dateModified:dateModified,dateCreated:dateCreated,author:{'@type':authorType,name:authorName},publisher:{'@type':'Organization',name:publisherName,logo:{'@type':'ImageObject',url:publisherLogo}},description:description,articleBody:body,speakable:speakable?speakable.map(function(item){return _objectSpread({'@type':'SpeakableSpecification'},item);}):undefined,keywords:Array.isArray(keywords)?keywords.join(', '):keywords},overrides);return/*#__PURE__*/_react["default"].createElement(_jsonld.JsonLd,{defer:defer,json:json});};exports.ArticleJsonLd=ArticleJsonLd;/**
 ...
 *
 * @public
 */var BlogPostJsonLd=function BlogPostJsonLd(_ref2){var overrides=_ref2.overrides,_ref2$defer=_ref2.defer,defer=_ref2$defer===void 0?false:_ref2$defer,_ref2$publisherLogo=_ref2.publisherLogo,publisherLogo=_ref2$publisherLogo===void 0?'':_ref2$publisherLogo,_ref2$publisherName=_ref2.publisherName,publisherName=_ref2$publisherName===void 0?'':_ref2$publisherName,props=(0,_objectWithoutProperties2["default"])(_ref2,["overrides","defer","publisherLogo","publisherName"]);return/*#__PURE__*/_react["default"].createElement(ArticleJsonLd,(0,_extends2["default"])({defer:defer,publisherName:publisherName,publisherLogo:publisherLogo},props,{overrides:_objectSpread(_objectSpread({},overrides),{},{'@type':'BlogPosting'})}));};exports.BlogPostJsonLd=BlogPostJsonLd;/**
 * A utility component which wraps the `<ArticleJsonLd />` component but is
 ...
 * );
 * ```
 */var NewsArticleJsonLd=function NewsArticleJsonLd(_ref3){var overrides=_ref3.overrides,section=_ref3.section,_ref3$defer=_ref3.defer,defer=_ref3$defer===void 0?false:_ref3$defer,props=(0,_objectWithoutProperties2["default"])(_ref3,["overrides","section","defer"]);return/*#__PURE__*/_react["default"].createElement(ArticleJsonLd,(0,_extends2["default"])({defer:defer},props,{overrides:_objectSpread(_objectSpread({articleSection:section},overrides),{},{'@type':'NewsArticle'})}));};exports.NewsArticleJsonLd=NewsArticleJsonLd;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.BlogJsonLd=void 0;var _defineProperty2=_interopRequireDefault(__webpack_require__(9713));var _react=_interopRequireDefault(__webpack_require__(8237));var _jsonld=__webpack_require__(7829);function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var BlogJsonLd=function BlogJsonLd(_ref){var url=_ref.url,headline=_ref.headline,title=_ref.title,_ref$images=_ref.images,images=_ref$images===void 0?[]:_ref$images,datePublished=_ref.datePublished,_ref$dateModified=_ref.dateModified,dateModified=_ref$dateModified===void 0?null:_ref$dateModified,authorName=_ref.authorName,_ref$authorType=_ref.authorType,authorType=_ref$authorType===void 0?'Person':_ref$authorType,keywords=_ref.keywords,description=_ref.description,publisherName=_ref.publisherName,publisherLogo=_ref.publisherLogo,_ref$posts=_ref.posts,posts=_ref$posts===void 0?[]:_ref$posts,issn=_ref.issn,_ref$overrides=_ref.overrides,overrides=_ref$overrides===void 0?{}:_ref$overrides,_ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer;var json=_objectSpread({'@context':'https://schema.org','@type':'Blog',mainEntityOfPage:{'@type':'Blog','@id':url},headline:headline!==null&&headline!==void 0?headline:title,keywords:keywords,issn:issn,image:images,datePublished:datePublished,dateModified:dateModified!==null&&dateModified!==void 0?dateModified:datePublished,description:description,author:authorName?{'@type':authorType,name:authorName}:undefined,publisher:publisherName?{'@type':'Organization',name:publisherName,logo:publisherLogo?{'@type':'ImageObject',url:publisherLogo}:undefined}:undefined,blogPost:posts.map(function(post){return _objectSpread({'@type':'BlogPosting'},post);})},overrides);return/*#__PURE__*/_react["default"].createElement(_jsonld.JsonLd,{defer:defer,json:json});};exports.BlogJsonLd=BlogJsonLd;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.BookJsonLd=void 0;var _objectWithoutProperties2=_interopRequireDefault(__webpack_require__(6479));var _defineProperty2=_interopRequireDefault(__webpack_require__(9713));var _react=_interopRequireDefault(__webpack_require__(8237));var _jsonld=__webpack_require__(7829);function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var getBookFormat=function getBookFormat(type){return type?"https://schema.org/".concat(type):undefined;};/**
 ...
 *
 * @public
 */var BookJsonLd=function BookJsonLd(_ref){var name=_ref.name,author=_ref.author,url=_ref.url,_ref$workExample=_ref.workExample,workExample=_ref$workExample===void 0?[]:_ref$workExample,id=_ref.id,sameAs=_ref.sameAs,_ref$overrides=_ref.overrides,overrides=_ref$overrides===void 0?{}:_ref$overrides,_ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer;var json=_objectSpread({'@context':'https://schema.org','@type':'Book',name:name,url:url,'@id':id,sameAs:sameAs,author:_objectSpread({'@type':'Person'},author),workExample:workExample.map(function(_ref2){var bookFormat=_ref2.bookFormat,potentialAction=_ref2.potentialAction,author=_ref2.author,rest=(0,_objectWithoutProperties2["default"])(_ref2,["bookFormat","potentialAction","author"]);return _objectSpread(_objectSpread({'@type':'Book',bookFormat:getBookFormat(bookFormat)},rest),{},{person:_objectSpread({'@type':'Person'},author),potentialAction:_objectSpread({'@type':'ReadAction'},potentialAction)});})},overrides);return/*#__PURE__*/_react["default"].createElement(_jsonld.JsonLd,{defer:defer,json:json});};exports.BookJsonLd=BookJsonLd;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.BreadcrumbJsonLd=void 0;var _defineProperty2=_interopRequireDefault(__webpack_require__(9713));var _react=_interopRequireDefault(__webpack_require__(8237));var _jsonld=__webpack_require__(7829);function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}/**
 ...
 * ```
 * *
 */var BreadcrumbJsonLd=function BreadcrumbJsonLd(_ref){var _ref$itemListElements=_ref.itemListElements,itemListElements=_ref$itemListElements===void 0?[]:_ref$itemListElements,_ref$overrides=_ref.overrides,overrides=_ref$overrides===void 0?{}:_ref$overrides,_ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer;var json=_objectSpread({'@context':'https://schema.org','@type':'BreadcrumbList',itemListElement:itemListElements.map(function(_ref2){var position=_ref2.position,item=_ref2.item,name=_ref2.name;return{'@type':'ListItem',position:position,item:{'@id':item,name:name,'@type':'Thing'}};})},overrides);return/*#__PURE__*/_react["default"].createElement(_jsonld.JsonLd,{defer:defer,json:json});};exports.BreadcrumbJsonLd=BreadcrumbJsonLd;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.CorporateContactJsonLd=void 0;var _react=_interopRequireDefault(__webpack_require__(8237));var _reactHelmetAsync=__webpack_require__(405);var formatIfArray=function formatIfArray(value){return Array.isArray(value)?"[".concat(value.map(function(val){return"\"".concat(val,"\"");}).toString(),"]"):"\"".concat(value,"\"");};var buildContactPoint=function buildContactPoint(contactPoint){return contactPoint.map(function(contact){return"{\n    \"@type\": \"ContactPoint\",\n    \"telephone\": \"".concat(contact.telephone,"\",\n    \"contactType\": \"").concat(contact.contactType,"\"").concat(contact.areaServed?",\n    \"areaServed\": ".concat(formatIfArray(contact.areaServed)):'').concat(contact.availableLanguage?",\n    \"availableLanguage\": ".concat(formatIfArray(contact.availableLanguage)):'').concat(contact.contactOption?",\n    \"contactOption\": \"".concat(contact.contactOption.toString(),"\""):'',"\n    }");});};/**
 * @deprecated
 *
 * See the
 * {@link https://developers.google.com/search/docs/data-types/corporate-contact | documentation}
 * with the reason for deprecation.
 */var CorporateContactJsonLd=function CorporateContactJsonLd(_ref){var url=_ref.url,logo=_ref.logo,contactPoint=_ref.contactPoint,_ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer;var jsonld="{\n    \"@context\": \"https://schema.org\",\n    \"@type\": \"Organization\",\n    \"url\": \"".concat(url,"\",\n    ").concat(logo?"\"logo\": \"".concat(logo,"\","):'',"\n    \"contactPoint\": [").concat(buildContactPoint(contactPoint).toString(),"]\n  }");return/*#__PURE__*/_react["default"].createElement(_reactHelmetAsync.Helmet,{defer:defer},/*#__PURE__*/_react["default"].createElement("script",{type:"application/ld+json"},jsonld));};exports.CorporateContactJsonLd=CorporateContactJsonLd;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.CourseJsonLd=void 0;var _defineProperty2=_interopRequireDefault(__webpack_require__(9713));var _react=_interopRequireDefault(__webpack_require__(8237));var _jsonld=__webpack_require__(7829);function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var CourseJsonLd=function CourseJsonLd(_ref){var name=_ref.name,courseName=_ref.courseName,description=_ref.description,providerName=_ref.providerName,providerUrl=_ref.providerUrl,_ref$overrides=_ref.overrides,overrides=_ref$overrides===void 0?{}:_ref$overrides,_ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer;var json=_objectSpread({'@context':'https://schema.org','@type':'Course',name:name!==null&&name!==void 0?name:courseName,description:description,provider:providerName?{'@type':'Organization',name:providerName,sameAs:providerUrl}:undefined},overrides);return/*#__PURE__*/_react["default"].createElement(_jsonld.JsonLd,{defer:defer,json:json});};exports.CourseJsonLd=CourseJsonLd;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.FAQJsonLd=void 0;var _defineProperty2=_interopRequireDefault(__webpack_require__(9713));var _react=_interopRequireDefault(__webpack_require__(8237));var _jsonld=__webpack_require__(7829);function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var transformMainEntity=function transformMainEntity(questions){return questions.map(function(_ref){var question=_ref.question,answer=_ref.answer;return{'@type':'Question',acceptedAnswer:{'@type':'Answer',text:answer},name:question};});};/**
 ...
 *
 * @public
 */var FAQJsonLd=function FAQJsonLd(_ref2){var mainEntity=_ref2.questions,_ref2$overrides=_ref2.overrides,overrides=_ref2$overrides===void 0?{}:_ref2$overrides,_ref2$defer=_ref2.defer,defer=_ref2$defer===void 0?false:_ref2$defer;var json=_objectSpread({'@context':'https://schema.org','@type':'FAQPage',mainEntity:transformMainEntity(mainEntity)},overrides);return/*#__PURE__*/_react["default"].createElement(_jsonld.JsonLd,{defer:defer,json:json});};exports.FAQJsonLd=FAQJsonLd;
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));var _article=__webpack_require__(4288);Object.keys(_article).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _article[key];}});});var _blog=__webpack_require__(6239);Object.keys(_blog).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _blog[key];}});});var _book=__webpack_require__(7527);Object.keys(_book).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _book[key];}});});var _breadcrumb=__webpack_require__(9839);Object.keys(_breadcrumb).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _breadcrumb[key];}});});var _corporateContact=__webpack_require__(4210);Object.keys(_corporateContact).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _corporateContact[key];}});});var _course=__webpack_require__(6279);Object.keys(_course).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _course[key];}});});var _faq=__webpack_require__(2745);Object.keys(_faq).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _faq[key];}});});var _jsonld=__webpack_require__(7829);Object.keys(_jsonld).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _jsonld[key];}});});var _localBusiness=__webpack_require__(1290);Object.keys(_localBusiness).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _localBusiness[key];}});});var _logo=__webpack_require__(330);Object.keys(_logo).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _logo[key];}});});var _product=__webpack_require__(8061);Object.keys(_product).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _product[key];}});});var _socialProfile=__webpack_require__(3168);Object.keys(_socialProfile).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _socialProfile[key];}});});var _speakable=__webpack_require__(627);Object.keys(_speakable).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _speakable[key];}});});
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.JsonLd=void 0;var _react=_interopRequireDefault(__webpack_require__(8237));var _reactHelmetAsync=__webpack_require__(405);/**
 ...
 * );
 * ```
 */var JsonLd=function JsonLd(_ref){var defer=_ref.defer,json=_ref.json;return/*#__PURE__*/_react["default"].createElement(_reactHelmetAsync.Helmet,{defer:defer},/*#__PURE__*/_react["default"].createElement("script",{type:"application/ld+json"},JSON.stringify(json,null,2)));};exports.JsonLd=JsonLd;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.LocalBusinessJsonLd=void 0;var _defineProperty2=_interopRequireDefault(__webpack_require__(9713));var _objectWithoutProperties2=_interopRequireDefault(__webpack_require__(6479));var _react=_interopRequireDefault(__webpack_require__(8237));var _jsonld=__webpack_require__(7829);function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var converter={Mon:'Monday',Tues:'Tuesday',Wed:'Wednesday',Thurs:'Thursday',Fri:'Friday',Sat:'Saturday',Sun:'Sunday'};var validDay=function validDay(day){var _converter;return"http://schema.org/".concat((_converter=converter[day])!==null&&_converter!==void 0?_converter:day);};var getDayOfWeek=function getDayOfWeek(dayOfWeek){return!dayOfWeek?undefined:Array.isArray(dayOfWeek)?dayOfWeek.map(validDay):validDay(dayOfWeek);};var getOpeningHoursSpecification=function getOpeningHoursSpecification(openingHours){if(!openingHours){return undefined;}if(Array.isArray(openingHours)){return openingHours.map(function(_ref){var dayOfWeek=_ref.dayOfWeek,rest=(0,_objectWithoutProperties2["default"])(_ref,["dayOfWeek"]);return _objectSpread({'@type':'OpeningHoursSpecification',dayOfWeek:getDayOfWeek(dayOfWeek)},rest);});}return _objectSpread(_objectSpread({'@type':'OpeningHoursSpecification'},openingHours),{},{dayOfWeek:getDayOfWeek(openingHours.dayOfWeek)});};/**
 ...
 * matched the query.
 */var LocalBusinessJsonLd=function LocalBusinessJsonLd(_ref2){var type=_ref2.type,id=_ref2.id,name=_ref2.name,description=_ref2.description,url=_ref2.url,telephone=_ref2.telephone,address=_ref2.address,geo=_ref2.geo,images=_ref2.images,openingHours=_ref2.openingHours,rating=_ref2.rating,priceRange=_ref2.priceRange,_ref2$overrides=_ref2.overrides,overrides=_ref2$overrides===void 0?{}:_ref2$overrides,_ref2$defer=_ref2.defer,defer=_ref2$defer===void 0?false:_ref2$defer;var json=_objectSpread({'@context':'https://schema.org','@type':type,'@id':id,name:name,description:description,url:url,telephone:telephone,priceRange:priceRange,image:images,geo:_objectSpread({'@type':'GeoCoordinates'},geo),address:_objectSpread({'@type':'PostalAddress'},address),aggregateRating:rating?_objectSpread({'@type':'AggregateRating'},rating):undefined,openingHoursSpecification:getOpeningHoursSpecification(openingHours)},overrides);return/*#__PURE__*/_react["default"].createElement(_jsonld.JsonLd,{defer:defer,json:json});};exports.LocalBusinessJsonLd=LocalBusinessJsonLd;
 ...
 * );
 * ```
 */var LogoJsonLd=function LogoJsonLd(_ref){var url=_ref.url,logo=_ref.logo,_ref$overrides=_ref.overrides,overrides=_ref$overrides===void 0?{}:_ref$overrides,_ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer;var json=_objectSpread({'@context':'https://schema.org','@type':'Organization',url:url,logo:logo},overrides);return/*#__PURE__*/_react["default"].createElement(_jsonld.JsonLd,{defer:defer,json:json});};exports.LogoJsonLd=LogoJsonLd;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.ProductJsonLd=void 0;var _objectWithoutProperties2=_interopRequireDefault(__webpack_require__(6479));var _defineProperty2=_interopRequireDefault(__webpack_require__(9713));var _react=_interopRequireDefault(__webpack_require__(8237));var _jsonld=__webpack_require__(7829);function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var availabilityConverter={Discontinued:'http://schema.org/Discontinued',InStock:'http://schema.org/InStock',InStoreOnly:'http://schema.org/InStoreOnly',LimitedAvailability:'http://schema.org/LimitedAvailability',OnlineOnly:'http://schema.org/OnlineOnly',OutOfStock:'http://schema.org/OutOfStock',PreOrder:'http://schema.org/PreOrder',PreSale:'http://schema.org/PreSale',SoldOut:'http://schema.org/SoldOut'};var itemConditionConverter={DamagedCondition:'http://schema.org/DamagedCondition',NewCondition:'http://schema.org/NewCondition',RefurbishedCondition:'http://schema.org/RefurbishedCondition',UsedCondition:'http://schema.org/UsedCondition'};var getAvailability=function getAvailability(availability){return availability?availabilityConverter[availability]:undefined;};var getItemCondition=function getItemCondition(itemCondition){return itemCondition?itemConditionConverter[itemCondition]:undefined;};/**
 ...
 *
 * @public
 */var ProductJsonLd=function ProductJsonLd(_ref){var _ref3;var name=_ref.name,productName=_ref.productName,_ref$images=_ref.images,images=_ref$images===void 0?[]:_ref$images,description=_ref.description,sku=_ref.sku,gtin12=_ref.gtin12,gtin=_ref.gtin,gtin8=_ref.gtin8,gtin13=_ref.gtin13,gtin14=_ref.gtin14,mpn=_ref.mpn,brand=_ref.brand,_ref$reviews=_ref.reviews,reviews=_ref$reviews===void 0?[]:_ref$reviews,aggregateRating=_ref.aggregateRating,offers=_ref.offers,_ref$offersType=_ref.offersType,offersType=_ref$offersType===void 0?'Offer':_ref$offersType,_ref$overrides=_ref.overrides,overrides=_ref$overrides===void 0?{}:_ref$overrides,_ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer;var json=_objectSpread({'@context':'https://schema.org','@type':'Product',name:name!==null&&name!==void 0?name:productName,image:images,sku:sku,gtin:gtin,gtin8:gtin8,gtin12:gtin12,gtin13:gtin13,gtin14:gtin14,mpn:mpn,brand:brand?{'@type':'Brand',name:brand}:undefined,description:description,review:reviews.map(function(_ref2){var reviewRating=_ref2.reviewRating,review=(0,_objectWithoutProperties2["default"])(_ref2,["reviewRating"]);return _objectSpread(_objectSpread({'@type':'Review'},review),{},{reviewRating:_objectSpread({'@type':'Rating'},reviewRating)});}),aggregateRating:aggregateRating?_objectSpread({'@type':'AggregateRating'},aggregateRating):undefined,offers:offers?_objectSpread(_objectSpread({'@type':offersType},offers),{},{availability:getAvailability(offers.availability),itemCondition:getItemCondition(offers.itemCondition),seller:offers.seller?{'@type':(_ref3=offers.seller.type)!==null&&_ref3!==void 0?_ref3:'Organization',name:offers.seller.name}:undefined}):undefined},overrides);return/*#__PURE__*/_react["default"].createElement(_jsonld.JsonLd,{defer:defer,json:json});};exports.ProductJsonLd=ProductJsonLd;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.SocialProfileJsonLd=void 0;var _react=_interopRequireDefault(__webpack_require__(8237));var _reactHelmetAsync=__webpack_require__(405);/**
 * @deprecated
 *
 * See the Google
 ...
 *
 * @internal
 */var SocialProfileJsonLd=function SocialProfileJsonLd(_ref){var type=_ref.type,name=_ref.name,url=_ref.url,_ref$sameAs=_ref.sameAs,sameAs=_ref$sameAs===void 0?[]:_ref$sameAs,_ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer;var jsonld="{\n    \"@context\": \"http://schema.org\",\n    \"@type\": \"".concat(type,"\",\n    \"name\": \"").concat(name,"\",\n    \"url\": \"").concat(url,"\",\n    \"sameAs\": [\n      ").concat(sameAs.map(function(socialUrl){return"\"".concat(socialUrl,"\"");}).toString(),"\n     ]\n  }");return/*#__PURE__*/_react["default"].createElement(_reactHelmetAsync.Helmet,{defer:defer},/*#__PURE__*/_react["default"].createElement("script",{type:"application/ld+json"},jsonld));};exports.SocialProfileJsonLd=SocialProfileJsonLd;
 ...
 *
 * @beta
 */var SpeakableJsonLd=function SpeakableJsonLd(_ref){var xpath=_ref.xpath,cssSelector=_ref.cssSelector,_ref$overrides=_ref.overrides,overrides=_ref$overrides===void 0?{}:_ref$overrides,_ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer;if(xpath&&cssSelector){throw new Error('Speakable should use either xpath or the cssSelector, not both.');}var json=_objectSpread({'@context':'https://schema.org','@type':'SpeakableSpecification',cssSelector:cssSelector,xpath:xpath},overrides);return/*#__PURE__*/_react["default"].createElement(_jsonld.JsonLd,{defer:defer,json:json});};exports.SpeakableJsonLd=SpeakableJsonLd;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.BaseSeo=exports.__resetDefaults=void 0;var _objectWithoutProperties2=_interopRequireDefault(__webpack_require__(6479));var _defineProperty2=_interopRequireDefault(__webpack_require__(9713));var _react=_interopRequireDefault(__webpack_require__(8237));var _reactHelmetAsync=__webpack_require__(405);function _createForOfIteratorHelper(o,allowArrayLike){var it;if(typeof Symbol==="undefined"||o[Symbol.iterator]==null){if(Array.isArray(o)||(it=_unsupportedIterableToArray(o))||allowArrayLike&&o&&typeof o.length==="number"){if(it)o=it;var i=0;var F=function F(){};return{s:F,n:function n(){if(i>=o.length)return{done:true};return{done:false,value:o[i++]};},e:function e(_e){throw _e;},f:F};}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}var normalCompletion=true,didErr=false,err;return{s:function s(){it=o[Symbol.iterator]();},n:function n(){var step=it.next();normalCompletion=step.done;return step;},e:function e(_e2){didErr=true;err=_e2;},f:function f(){try{if(!normalCompletion&&it["return"]!=null)it["return"]();}finally{if(didErr)throw err;}}};}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_defineProperty2["default"])(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}var BASE_DEFAULTS={noindex:false,nofollow:false,defaultOpenGraphImageWidth:0,defaultOpenGraphImageHeight:0,defaultOpenGraphVideoWidth:0,defaultOpenGraphVideoHeight:0};var DEFAULTS=_objectSpread({},BASE_DEFAULTS);/**
 * Reset all the defaults.
 *
 * @internal
 */var __resetDefaults=function __resetDefaults(){DEFAULTS=_objectSpread({},BASE_DEFAULTS);};/**
 ...
 *
 * @public
 */exports.__resetDefaults=__resetDefaults;var BaseSeo=function BaseSeo(_ref){var _props$noindex,_props$nofollow;var _ref$defer=_ref.defer,defer=_ref$defer===void 0?false:_ref$defer,_ref$metaTags=_ref.metaTags,metaTags=_ref$metaTags===void 0?[]:_ref$metaTags,_ref$linkTags=_ref.linkTags,linkTags=_ref$linkTags===void 0?[]:_ref$linkTags,props=(0,_objectWithoutProperties2["default"])(_ref,["defer","metaTags","linkTags"]);var meta=[];var link=[];var noindex=((_props$noindex=props.noindex)!==null&&_props$noindex!==void 0?_props$noindex:DEFAULTS.noindex)||props.dangerouslySetAllPagesToNoIndex;var nofollow=((_props$nofollow=props.nofollow)!==null&&_props$nofollow!==void 0?_props$nofollow:DEFAULTS.nofollow)||props.dangerouslySetAllPagesToNoFollow;var indexTags=['robots','googlebot'];if(noindex||nofollow){if(props.dangerouslySetAllPagesToNoIndex){DEFAULTS.noindex=true;}if(props.dangerouslySetAllPagesToNoFollow){DEFAULTS.nofollow=true;}var _iterator=_createForOfIteratorHelper(indexTags),_step;try{for(_iterator.s();!(_step=_iterator.n()).done;){var name=_step.value;meta.push({name:name,content:"".concat(noindex?'noindex':'index',",").concat(nofollow?'nofollow':'follow')});}}catch(err){_iterator.e(err);}finally{_iterator.f();}}else{var _iterator2=_createForOfIteratorHelper(indexTags),_step2;try{for(_iterator2.s();!(_step2=_iterator2.n()).done;){var _name=_step2.value;meta.push({name:_name,content:'index,follow'});}}catch(err){_iterator2.e(err);}finally{_iterator2.f();}}if(props.description){meta.push({name:'description',content:props.description});}if(props.mobileAlternate){link.push({rel:'alternate',media:props.mobileAlternate.media,href:props.mobileAlternate.href});}if(props.languageAlternates&&props.languageAlternates.length>0){props.languageAlternates.forEach(function(languageAlternate){link.push({rel:'alternate',key:"languageAlternate-".concat(languageAlternate.hrefLang),hrefLang:languageAlternate.hrefLang,href:languageAlternate.href});});}if(props.twitter){if(props.twitter.cardType){meta.push({name:'twitter:card',content:props.twitter.cardType});}if(props.twitter.site){meta.push({name:'twitter:site',content:props.twitter.site});}if(props.twitter.handle){meta.push({name:'twitter:creator',content:props.twitter.handle});}}if(props.facebook){if(props.facebook.appId){meta.push({property:'fb:app_id',content:props.facebook.appId});}}if(props.openGraph){var _props$openGraph$imag,_props$openGraph$vide5;if(props.openGraph.url||props.canonical){var _props$openGraph$url;meta.push({property:'og:url',content:(_props$openGraph$url=props.openGraph.url)!==null&&_props$openGraph$url!==void 0?_props$openGraph$url:props.canonical});}if(props.openGraph.type){var type=props.openGraph.type.toLowerCase();meta.push({property:'og:type',content:type});if(type==='profile'&&props.openGraph.profile){if(props.openGraph.profile.firstName){meta.push({property:'profile:first_name',content:props.openGraph.profile.firstName});}if(props.openGraph.profile.lastName){meta.push({property:'profile:last_name',content:props.openGraph.profile.lastName});}if(props.openGraph.profile.username){meta.push({property:'profile:username',content:props.openGraph.profile.username});}if(props.openGraph.profile.gender){meta.push({property:'profile:gender',content:props.openGraph.profile.gender});}}else if(type==='book'&&props.openGraph.book){var _props$openGraph$book,_props$openGraph$book2;if((_props$openGraph$book=props.openGraph.book.authors)===null||_props$openGraph$book===void 0?void 0:_props$openGraph$book.length){props.openGraph.book.authors.forEach(function(author){meta.push({property:'book:author',content:author});});}if(props.openGraph.book.isbn){meta.push({property:'book:isbn',content:props.openGraph.book.isbn});}if(props.openGraph.book.releaseDate){meta.push({property:'book:release_date',content:props.openGraph.book.releaseDate});}if((_props$openGraph$book2=props.openGraph.book.tags)===null||_props$openGraph$book2===void 0?void 0:_props$openGraph$book2.length){props.openGraph.book.tags.forEach(function(tag){meta.push({property:'book:tag',content:tag});});}}else if(type==='article'&&props.openGraph.article){var _props$openGraph$arti,_props$openGraph$arti2;if(props.openGraph.article.publishedTime){meta.push({property:'article:published_time',content:props.openGraph.article.publishedTime});}if(props.openGraph.article.modifiedTime){meta.push({property:'article:modified_time',content:props.openGraph.article.modifiedTime});}if(props.openGraph.article.expirationTime){meta.push({property:'article:expiration_time',content:props.openGraph.article.expirationTime});}if((_props$openGraph$arti=props.openGraph.article.authors)===null||_props$openGraph$arti===void 0?void 0:_props$openGraph$arti.length){props.openGraph.article.authors.forEach(function(author){meta.push({property:'article:author',content:author});});}if(props.openGraph.article.section){meta.push({property:'article:section',content:props.openGraph.article.section});}if((_props$openGraph$arti2=props.openGraph.article.tags)===null||_props$openGraph$arti2===void 0?void 0:_props$openGraph$arti2.length){props.openGraph.article.tags.forEach(function(tag){meta.push({property:'article:tag',content:tag});});}}else if((type==='video.movie'||type==='video.episode'||type==='video.tv_show'||type==='video.other')&&props.openGraph.video){var _props$openGraph$vide,_props$openGraph$vide2,_props$openGraph$vide3,_props$openGraph$vide4;if((_props$openGraph$vide=props.openGraph.video.actors)===null||_props$openGraph$vide===void 0?void 0:_props$openGraph$vide.length){props.openGraph.video.actors.forEach(function(actor){if(actor.profile){meta.push({property:'video:actor',content:actor.profile});}if(actor.role){meta.push({property:'video:actor:role',content:actor.role});}});}if((_props$openGraph$vide2=props.openGraph.video.directors)===null||_props$openGraph$vide2===void 0?void 0:_props$openGraph$vide2.length){props.openGraph.video.directors.forEach(function(director){meta.push({property:'video:director',content:director});});}if((_props$openGraph$vide3=props.openGraph.video.writers)===null||_props$openGraph$vide3===void 0?void 0:_props$openGraph$vide3.length){props.openGraph.video.writers.forEach(function(writer){meta.push({property:'video:writer',content:writer});});}if(props.openGraph.video.duration){meta.push({property:'video:duration',content:props.openGraph.video.duration.toString()});}if(props.openGraph.video.releaseDate){meta.push({property:'video:release_date',content:props.openGraph.video.releaseDate});}if((_props$openGraph$vide4=props.openGraph.video.tags)===null||_props$openGraph$vide4===void 0?void 0:_props$openGraph$vide4.length){props.openGraph.video.tags.forEach(function(tag){meta.push({property:'video:tag',content:tag});});}if(props.openGraph.video.series){meta.push({property:'video:series',content:props.openGraph.video.series});}}}if(props.openGraph.title||props.title){var _props$openGraph$titl,_props$titleTemplate,_props$title;meta.push({property:'og:title',content:(_props$openGraph$titl=props.openGraph.title)!==null&&_props$openGraph$titl!==void 0?_props$openGraph$titl:((_props$titleTemplate=props.titleTemplate)!==null&&_props$titleTemplate!==void 0?_props$titleTemplate:'').replace('%s',(_props$title=props.title)!==null&&_props$title!==void 0?_props$title:'')});}if(props.openGraph.description||props.description){var _props$openGraph$desc;meta.push({property:'og:description',content:(_props$openGraph$desc=props.openGraph.description)!==null&&_props$openGraph$desc!==void 0?_props$openGraph$desc:props.description});}// images
if(props.defaultOpenGraphImageWidth){DEFAULTS.defaultOpenGraphImageWidth=props.defaultOpenGraphImageWidth;}if(props.defaultOpenGraphImageHeight){DEFAULTS.defaultOpenGraphImageHeight=props.defaultOpenGraphImageHeight;}if((_props$openGraph$imag=props.openGraph.images)===null||_props$openGraph$imag===void 0?void 0:_props$openGraph$imag.length){props.openGraph.images.forEach(function(image){meta.push({property:'og:image',content:image.url});if(image.alt){meta.push({property:'og:image:alt',content:image.alt});}if(image.width){meta.push({property:'og:image:width',content:image.width.toString()});}else if(DEFAULTS.defaultOpenGraphImageWidth){meta.push({property:'og:image:width',content:DEFAULTS.defaultOpenGraphImageWidth.toString()});}if(image.height){meta.push({property:'og:image:height',content:image.height.toString()});}else if(DEFAULTS.defaultOpenGraphImageHeight){meta.push({property:'og:image:height',content:DEFAULTS.defaultOpenGraphImageHeight.toString()});}});}// videos
if(props.defaultOpenGraphVideoWidth){DEFAULTS.defaultOpenGraphVideoWidth=props.defaultOpenGraphVideoWidth;}if(props.defaultOpenGraphVideoHeight){DEFAULTS.defaultOpenGraphVideoHeight=props.defaultOpenGraphVideoHeight;}if((_props$openGraph$vide5=props.openGraph.videos)===null||_props$openGraph$vide5===void 0?void 0:_props$openGraph$vide5.length){props.openGraph.videos.forEach(function(video){meta.push({property:'og:video',content:video.url});if(video.alt){meta.push({property:'og:video:alt',content:video.alt});}if(video.width){meta.push({property:'og:video:width',content:video.width.toString()});}else if(DEFAULTS.defaultOpenGraphVideoWidth){meta.push({property:'og:video:width',content:DEFAULTS.defaultOpenGraphVideoWidth.toString()});}if(video.height){meta.push({property:'og:video:height',content:video.height.toString()});}else if(DEFAULTS.defaultOpenGraphVideoHeight){meta.push({property:'og:video:height',content:DEFAULTS.defaultOpenGraphVideoHeight.toString()});}});}if(props.openGraph.locale){meta.push({property:'og:locale',content:props.openGraph.locale});}if(props.openGraph.site_name){meta.push({property:'og:site_name',content:props.openGraph.site_name});}}if(props.canonical){link.push({rel:'canonical',href:props.canonical,key:'canonical'});}metaTags.forEach(function(tag){meta.push(tag);});linkTags.forEach(function(tag){link.push(tag);});var htmlAttributes=props.language?_objectSpread({lang:props.language},props.htmlAttributes):_objectSpread({},props.htmlAttributes);var helmetProps={meta:meta,link:link,defer:defer,htmlAttributes:htmlAttributes};if(props.title){helmetProps['title']=props.title;}if(props.titleTemplate){helmetProps['titleTemplate']=props.titleTemplate;}return/*#__PURE__*/_react["default"].createElement(_react["default"].Fragment,null,/*#__PURE__*/_react["default"].createElement(_reactHelmetAsync.Helmet,helmetProps));};exports.BaseSeo=BaseSeo;
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);Object.defineProperty(exports, "__esModule", ({value:true}));exports.GatsbySeo=void 0;var _react=_interopRequireDefault(__webpack_require__(8237));var _baseSeo=__webpack_require__(9777);/**
 ...
 *
 * @public
 */var GatsbySeo=function GatsbySeo(_ref){var metaTags=_ref.metaTags,linkTags=_ref.linkTags,canonical=_ref.canonical,description=_ref.description,facebook=_ref.facebook,htmlAttributes=_ref.htmlAttributes,language=_ref.language,languageAlternates=_ref.languageAlternates,mobileAlternate=_ref.mobileAlternate,nofollow=_ref.nofollow,noindex=_ref.noindex,openGraph=_ref.openGraph,title=_ref.title,titleTemplate=_ref.titleTemplate,twitter=_ref.twitter;return/*#__PURE__*/_react["default"].createElement(_baseSeo.BaseSeo,{metaTags:metaTags,linkTags:linkTags,canonical:canonical,description:description,facebook:facebook,htmlAttributes:htmlAttributes,language:language,languageAlternates:languageAlternates,mobileAlternate:mobileAlternate,nofollow:nofollow,noindex:noindex,openGraph:openGraph,title:title,titleTemplate:titleTemplate,twitter:twitter});};exports.GatsbySeo=GatsbySeo;
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));var _baseSeo=__webpack_require__(9777);Object.keys(_baseSeo).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _baseSeo[key];}});});var _gatsbySeo=__webpack_require__(8464);Object.keys(_gatsbySeo).forEach(function(key){if(key==="default"||key==="__esModule")return;Object.defineProperty(exports,key,{enumerable:true,get:function get(){return _gatsbySeo[key];}});});
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports.getFilledContext=exports.emptyContext=void 0;var emptyContext={};exports.emptyContext=emptyContext;var getFilledContext=function getFilledContext(){var filledContext=emptyContext;if(!filledContext.helmet){return undefined;}return emptyContext;};exports.getFilledContext=getFilledContext;
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(8237));var _gatsby=__webpack_require__(2031);var _path=__webpack_require__(1423);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
// EXTERNAL MODULE: ./src/images/logocompleto.webp
var logocompleto = __webpack_require__(3852);
;// CONCATENATED MODULE: ./src/commons/Footer/index.js
const Footer=()=>/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("footer",{className:"footer flex flex-col md:flex-row items-center justify-between flex-wrap w-screen p-3 lg:px-36 xl:px-48 py-20"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"footer__section"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("img",{src:logocompleto/* default */.Z,alt:"brisa sonora logo",className:"footer__section__logo"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("address",{className:"mt-4"},"Via Ten Garozzo 2 Aci Sant'antonio, Catania"),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a",{href:"https://www.iubenda.com/privacy-policy/10563366",title:"Privacy Policy "},"Privacy Policy")),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"footer__section flex justify-between"},socials.map(({src,href},index)=>/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a",{href:href,key:src.split(".")[0]},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("img",{src:src,alt:href.slice(12,20),className:"footer__section__social "+(index!==0?"ml-3":"")})))),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"footer__section mt-20 md:mt-0"},"Developed by",/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a",{href:"https://www.linkedin.com/in/mirko-torrisi/"}," Mirko Torrisi")));/* harmony default export */ const commons_Footer = (Footer);
...
var NavContext = __webpack_require__(4763);
;// CONCATENATED MODULE: ./src/commons/Navbar/NavLink.js
const NavLink=({link,children})=>{const{activeNavLinkId,setActiveNavLinkId}=(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useContext)(NavContext/* NavContext */.L);const handleClick=()=>{setActiveNavLinkId(link);};return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"nav__item__block"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a",{href:link,className:`block nav__item p-0 py-6 lg:p-6 lg:inline-block ${activeNavLinkId===link?"activeClass":""}`,onClick:handleClick,id:link},children));};/* harmony default export */ const Navbar_NavLink = (NavLink);
// EXTERNAL MODULE: ./src/images/logocompleto.webp
var logocompleto = __webpack_require__(3852);
;// CONCATENATED MODULE: ./src/commons/Navbar/index.js
const Navbar=()=>{const[menuShow,setMenu]=external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().useState(false);const showMenu=()=>setMenu(!menuShow);return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("nav",{className:"navbar flex fixed items-center justify-between flex-wrap w-screen py-4 lg:py-0 px-10 "},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a",{href:"/#hero-section"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("img",{src:logocompleto/* default */.Z,alt:"logo-brisa",className:"navbar__logo"})),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"flex align-center justify-between lg:hidden"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("button",{"aria-label":"menu",className:"mr-10 w-0",onClick:showMenu},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{id:"hamburger",className:"hamburglar "+(menuShow?"is-open":"is-closed")},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"burger-icon"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"burger-container"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("span",{className:"burger-bun-top"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("span",{className:"burger-filling"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("span",{className:"burger-bun-bot"}))),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"path-burger"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"animate-path"}))))),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:`w-full block lg:flex lg:items-right lg:w-auto ${menuShow?"":"h-0"} lg:h-full`},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:` ${!menuShow?"hidden":""} lg:flex flex-col lg:flex-row  mt-5 lg:mt-0 lg:px-36`},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(Navbar_NavLink,{link:"/#about"},"La scuola"),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(Navbar_NavLink,{link:"/#contact"},"Contatti"),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(Navbar_NavLink,{link:"/#findus"},"Dove Trovarci"),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(Navbar_NavLink,{link:"/blog"},"Materiale gratuito"))));};/* harmony default export */ const commons_Navbar = (Navbar);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8237);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
const NavContext=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createContext();const NavProvider=({children})=>{const{0:activeNavLinkId,1:setActiveNavLinkId}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");const providerValue={activeNavLinkId,setActiveNavLinkId};return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(NavContext.Provider,{value:providerValue},children);};
...
/* harmony import */ var gatsby_plugin_next_seo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2492);
/* harmony import */ var gatsby_plugin_next_seo__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(gatsby_plugin_next_seo__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var gatsby_image__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1496);
/* harmony import */ var _commons_Navbar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2455);
/* harmony import */ var _commons_Footer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4525);
/* harmony import */ var react_helmet__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4593);
/* harmony import */ var _images_logo_brisa_webp__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(4126);
/* harmony import */ var _context_NavContext__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4763);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (({data})=>{console.log(data.allWpPost.edges);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{id:"fb-root"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("script",{async:true,defer:true,crossorigin:"anonymous",src:"https://connect.facebook.net/it_IT/sdk.js#xfbml=1&version=v13.0&appId=73794053396&autoLogAppEvents=1",nonce:"TMMP1UPy"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_6__.Helmet,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("meta",{charSet:"utf-8"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("meta",{name:"description",content:"Brisa Sonora corsi di musica, lezioni di pianoforte, chitarra, violino, sassofono a Catania. associazione musicale."}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("meta",{name:"google-site-verification",content:"1PIQqEL0OgbiTPjG0fiPZ9rOcO30wM00ZIqtViP6IWo"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("meta",{name:"keywords",content:"musica lezioni online corsi pianoforte violino sassofono chitarra catania san gregorio strumenti musicali aci sant'antonio paesi etnei valverde aci catena corsi di musica associazione musicale conservatorio"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("title",null,"Brisa Sonora")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_plugin_next_seo__WEBPACK_IMPORTED_MODULE_2__.GatsbySeo,{title:"BrisaSonora lezioni di musica",description:"Articoli e news sulla musica. Lezioni di musica. Video didattici. Tutorial per leggere uno spartito, suonare il pianoforte, riconoscere le note su una tastiera. Impara a suonare con noi!",canonical:"https://brisasonora.it/",openGraph:{url:"https://brisasonora.it",title:"Blog di BrisaSonora - Video e articoli per conoscere la musica",description:"Articoli sulla musica. Lezioni di musica. Video didattici. Tutorial per leggere uno spartito, suonare il pianoforte, riconoscere le note su una tastiera.",images:[{url:_images_logo_brisa_webp__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .Z,width:800,height:600,alt:"Logo BrisaSonora"}],locale:"it_IT",language:"it",site_name:"BrisaSonora"},twitter:{handle:"@handle",site:"@brisasonora",cardType:"summary_large_image"}}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_context_NavContext__WEBPACK_IMPORTED_MODULE_7__/* .NavProvider */ .N,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_commons_Navbar__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section",{className:"blog w-full h-full  flex items-center justify-between flex-col"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"hero-section__title mt-36"},"Contenuti didattici di BrisaSonora"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul",{style:{listStyle:"none"},className:"article_container lg:w-1/2 p-5 mt-24"},data.allWpPost.edges.map(post=>{var _post$node$featuredIm,_post$node$featuredIm2;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",{style:{padding:"20px 0",borderBottom:"1px solid #eeeeee"}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:`/post/${post.node.slug}`,style:{display:"flex",color:"black",textDecoration:"none"}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_image__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z,{fixed:(_post$node$featuredIm=post.node.featuredImage)===null||_post$node$featuredIm===void 0?void 0:(_post$node$featuredIm2=_post$node$featuredIm.node)===null||_post$node$featuredIm2===void 0?void 0:_post$node$featuredIm2.uri,alt:post.node.title}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",{className:"middle-section__picture__title mb-1 mt-20 lg:mt-0"},post.node.title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3",{className:"article__date mb-5"},post.node.date),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{dangerouslySetInnerHTML:{__html:post.node.excerpt}}))));}))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_commons_Footer__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z,null)));});const pageQuery="900768573";
...
const useOnScreen=ref=>{const{0:isOnScreen,1:setisOnScreen}=(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useState)(false);const observer=(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useRef)(null);(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useEffect)(()=>{observer.current=new IntersectionObserver(([entry])=>setisOnScreen(entry.isIntersecting),{threshold:[0.25,0.5,0.75]});},[]);(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useEffect)(()=>{if(!observer.current)return;observer.current.observe(ref.current);return()=>{observer.current.disconnect();};});return isOnScreen;};
// EXTERNAL MODULE: ./src/context/NavContext.js
var NavContext = __webpack_require__(4763);
;// CONCATENATED MODULE: ./src/hooks/useNav.js
const useNav=navLinkId=>{const ref=(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useRef)(null);const{setActiveNavLinkId}=(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useContext)(NavContext/* NavContext */.L);const isOnScreen=useOnScreen(ref);(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useEffect)(()=>{if(isOnScreen){setActiveNavLinkId(navLinkId);}},[isOnScreen,setActiveNavLinkId,navLinkId]);return ref;};
...
let interval;function HeroSection(){const ref=useNav("#home");const q=gsapWithCSS.utils.selector(ref);let tl=gsapWithCSS.timeline({delay:1});const{0:index,1:setindex}=(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useState)(0);(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useEffect)(()=>{interval=setInterval(()=>{setindex(prev=>prev<quotes.length-1?prev+1:0);tl.fromTo(q(".text"),{y:"100%",letterSpacing:"15px",duration:0.5,stagger:0.25},{y:"0%",letterSpacing:"0px",duration:0.5,stagger:0.25});},5000);gsapWithCSS.to(q(".ond-even"),{x:300,opacity:0,duration:1,delay:0.5});gsapWithCSS.to(q(".ond-odd"),{x:-300,opacity:0,duration:1,delay:0.5});tl.from(q(".hero-section__title"),{opacity:0,duration:0.5});gsapWithCSS.timeline({defaults:{duration:1},scrollTrigger:{trigger:"#violin",start:"top center",end:"bottom center",scrub:true}}).fromTo(q("#violin"),{right:"20%"},{right:"-30%"});gsapWithCSS.timeline({defaults:{duration:1},scrollTrigger:{trigger:"#violin",start:"top center",end:"bottom center",scrub:true}}).fromTo(q("#piano"),{right:0,rotation:60},{right:-200,rotation:130});return()=>clearInterval(interval);},[]);return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("header",{className:"hero-section h-screen px-10 lg:px-36 xl:px-48",id:"hero-section"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"hero-section__main h-full flex flex-col justify-between items-start py-36",ref:ref},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement((ondineMod_anim_default()),{className:"ondine"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("img",{src:violin,alt:"violin",id:"violin","aria-hidden":"true",className:"hero-section__violin hidden lg:block"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("img",{src:pianoPng,alt:"piano",id:"piano","aria-hidden":"true",className:"hero-section__violin piano hidden lg:block"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"hero-section__title my-10"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h1",null,"Impara a ",/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("span",null,"suonare")," con noi")),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h2",{className:"hero-section__proposal  lg:mb-10"},"Prenota ora la tua lezione di prova gratuita online o in presenza"),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"hero-section__ctas "},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("button",{className:"hero-section__ctas__contact mt-10 lg:mt-0"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a",{href:"#contact",className:"contact_cta"},"Contattaci"))),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"hero-section__quote mt-36"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("p",{className:"hero-section__subtitle hide "+(quotes[index].secondline?"":"mb-5")},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("span",{className:"text"},quotes[index].quote)),quotes[index].secondline&&/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("p",{className:"hero-section__subtitle hide mb-5"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("span",{className:"text"},quotes[index].secondline)),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("p",{className:"hero-section__subtitle__author hide mb-5"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("span",{className:"text"},quotes[index].author)))));}
...
function MiddleSection(){const ref=useNav("#about");const q=gsapWithCSS.utils.selector(ref);(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useEffect)(()=>{pictures.forEach((pic,i)=>{gsapWithCSS.timeline({scrollTrigger:{trigger:`#middle-${i}`,start:"top center"}}).from(q(`#img-${i}`),{xPercent:-50,opacity:0},0).from(q(`#p-${i}`),{xPercent:50,opacity:0},0);});},[]);return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement((external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default()).Fragment,null,/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("section",{className:"middle-section pt-20 px-10 lg:px-36 xl:px-48",ref:ref,id:"about"},pictures.map((pic,i)=>/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"mt-20",key:pic.title,id:`middle-${i}`},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h2",{className:"middle-section__picture__title mb-10 mt-20 lg:mt-0"},pic.title),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:`middle-section__picture items-start lg:items-center ${i!==pictures.length-1?"pb-36":""} ${i%2===0?"row-reverse":"row"} flex flex-col`,key:pic.alt+i+"o"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("img",{src:pic.src,alt:pic.alt,className:`middle-section__picture__img ${i%2===0?"lg:ml-10":"lg:mr-10"}`,id:`img-${i}`}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("p",{className:"middle-section__picture__desc mt-20 lg:mt-0 ",id:`p-${i}`},pic.desc))))),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"svgContainer"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement((vaweSvg_default()),null)));}
...
function Teacher({teacher,instrument}){const ref=(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useRef)(null);const q=gsapWithCSS.utils.selector(ref);const name=teacher===null||teacher===void 0?void 0:teacher.name.split(" ")[0];(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useEffect)(()=>{gsapWithCSS.timeline({scrollTrigger:{trigger:`#${name}`,start:"top center"}}).from(q(`#${name}-desc`),{yPercent:50,opacity:0,stagger:0.5},0);gsapWithCSS.timeline({defaults:{duration:1},scrollTrigger:{trigger:q(`#${name}`),start:"top bottom",end:"bottom top",scrub:true}}).to(q(`#${name}-instrument`),{y:"10%",x:"30%"});gsapWithCSS.timeline({defaults:{duration:1},scrollTrigger:{trigger:q(".teacher"),start:"top bottom",end:"bottom top",scrub:true}}).to(q(`#${name}-picture`),{y:"10%"});},[]);return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"flex flex-col mt-20 lg:mt-0 teacher",ref:ref,id:name},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h2",{className:"teachers-section__name mt-10"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("img",{src:instrument.imgSrc,"aria-hidden":"true",alt:instrument.imgSrc,className:"hero-section__list__icon"}),teacher===null||teacher===void 0?void 0:teacher.name),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"flex space-between flex-col md:flex-row md:items-center"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"mb-10 teacher-carousel",style:{perspective:"1000px",transformStyle:"preserve-3d"}},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("img",{src:teacher===null||teacher===void 0?void 0:teacher.instrument,alt:teacher===null||teacher===void 0?void 0:teacher.altInstr,className:`teachers-section__picture__instrument noselect`,id:`${name}-instrument`,style:{transform:`rotateY(180deg) translateX(-30%) rotateX(-200deg) translateZ(-1px)`,WebkitTransform:`rotateY(180deg)`}}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("img",{src:teacher===null||teacher===void 0?void 0:teacher.src,alt:teacher===null||teacher===void 0?void 0:teacher.alt,className:`teachers-section__picture__face noselect`,id:`${name}-picture`,style:{position:"absolute",backfaceVisibility:"hidden",margin:20,transform:`translateZ(100px) translateY(100}px)`,WebkitTransform:`translateZ(100px) translateY(100px)`,transition:"transform 0.2s"}})),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"teachers-section__desc p-10",id:`${name}-desc`},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("p",{className:"teachers-section__bio"},teacher===null||teacher===void 0?void 0:teacher.bio))));}
;// CONCATENATED MODULE: ./src/sections/TeachersSection/index.js
function TeachersSection(){return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("section",{className:"teachers-section  pt-36 lg:pb-10 px-10 lg:px-36 xl:px-48"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h2",{className:"title mb-10 lg:mt-20"},"I docenti"),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(Teacher,{teacher:teachers[0],instrument:instruments[0]}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(Teacher,{teacher:teachers[1],instrument:instruments[1]}));}
...
function FindusSection(){const ref=useNav("#findus");const q=gsapWithCSS.utils.selector(ref);(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useEffect)(()=>{gsapWithCSS.timeline({scrollTrigger:{trigger:".find-us",start:"top center"}}).from(q(".title"),{xPercent:-50,opacity:0},0).from(q("address"),{xPercent:50,opacity:0},0);gsapWithCSS.timeline({defaults:{duration:1},scrollTrigger:{trigger:".notes_cover",start:"top center",end:"bottom top",scrub:true}}).to(q(".notes_cover"),{x:"100%"});},[]);function deferIframe(){var iframeElem=document.getElementsByTagName("iframe");for(var i=0;i<iframeElem.length;i++){if(iframeElem[i].getAttribute("data-src")){iframeElem[i].setAttribute("src",iframeElem[i].getAttribute("data-src"));}}}(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useEffect)(()=>{setTimeout(()=>deferIframe(),5000);},[]);return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("section",{className:"find-us",id:"findus",ref:ref},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"notes_cont"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"notes_cover"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement((note_with_righe_default()),{style:{transform:"translateX(-30px)",width:"100vw",height:264}})),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"lg:pt-20 mb-5 px-10 lg:px-36 xl:px-48"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h2",{className:"title"},"Dove ci troviamo"),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("address",{className:"mt-10 pl-2 "},"La nostra sede \xE8 in Via Tenente Garozzo, 2 95025",/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("p",null,"Aci Sant'Antonio (CT)"))),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{style:{height:380,overflow:"hidden",clipPath:"polygon(0 20%, 100% 20%, 100% 100%, 0% 100%)"}},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("iframe",{title:"maps",src:"","data-src":"https://www.google.com/maps/d/u/0/embed?mid=18inuwOcaxrVr2UiiT0nQYhG3k1Ww9w8s",width:"100%",height:"380"})));}
// EXTERNAL MODULE: ./src/commons/Navbar/index.js + 1 modules
var Navbar = __webpack_require__(2455);
// EXTERNAL MODULE: ./src/commons/Footer/index.js + 5 modules
var Footer = __webpack_require__(4525);
// EXTERNAL MODULE: ./node_modules/react-helmet/es/Helmet.js
var Helmet = __webpack_require__(4593);
// EXTERNAL MODULE: ./src/images/logo_brisa.webp
var logo_brisa = __webpack_require__(4126);
...
function ContactSection(){const ref=useNav("#contact");const{0:input,1:setInput}=(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useState)("");const{0:contact,1:setContact}=(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useState)("");const{0:modalMsg,1:setModalMsg}=(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useState)("");const handleInput=e=>setInput(e.target.value);const handleContact=e=>setContact(e.target.value);const q=gsapWithCSS.utils.selector(ref);const sendMessage=async e=>{e.preventDefault();const res=await requestSendMessage({input,contact});setModalMsg(res);};(0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useEffect)(()=>{gsapWithCSS.timeline({scrollTrigger:{trigger:".contact-section",start:"top center"}}).from(q(".title"),{xPercent:-50,opacity:0},0).from(q("textarea"),{xPercent:-50,opacity:0},0).from(q("button"),{xPercent:50,opacity:0},0).from(q("h3"),{xPercent:-50,opacity:0},0);},[]);return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("section",{className:"contact-section py-36 lg:py-20 px-10 lg:px-36 xl:px-48",ref:ref,id:"contact"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h2",{className:"title"},"Contattaci"),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"contact-section__form mt-20"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h3",{className:"contact-section__form__title"},"Prenota ora la tua lezione di prova gratuita, ti risponderemo il prima possibile!"),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("form",{className:"flex flex-col items-start mt-5",onSubmit:sendMessage},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("input",{type:"text",id:"contact",placeholder:"Il tuo numero o la tua email",className:"contact-section__form__email mt-5",required:true,pattern:"^([a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,3})|(\\d{3}\\d{3}\\d{4})$",onChange:handleContact}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"contact-section__form__input__container"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("textarea",{id:"message",type:"text",required:true,className:`contact-section__form__input mt-10`,style:{minHeight:"3rem",height:`${input.length/10}rem`},placeholder:"Salve, vorrei avere maggiori informazioni...",ref:ref,onChange:handleInput,value:input})),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("input",{type:"submit",className:"contact-section__form__submit mt-10",value:"Prenota"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("p",{className:"contact-section__form__privacy"},"Cliccando su Prenota aderisci alla nostra",/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a",{href:"https://www.iubenda.com/privacy-policy/10563366",title:"Privacy Policy",className:"ml-2 hoverable",target:"_blank"},"Privacy Policy"))),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h3",{className:"mt-20"},"In alternativa, puoi chiamare uno di questi numeri:",/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a",{href:`tel:${PHONE_NUMBER}`,className:"phone_number hoverable"},"+39 ",PHONE_NUMBER),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a",{href:`tel:${LAURA_NUMBER}`,className:"phone_number hoverable"},"+39 ",LAURA_NUMBER),"O mandare un'email a",/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a",{href:`mailto:${EMAIL}`,className:"phone_number hoverable"},EMAIL))),modalMsg&&/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"modalContainer"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"contactmodal"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("div",{className:"overlay"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h3",{className:"modal__msg"},modalMsg),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("button",{className:"contact-section__form__submit mt-10",onClick:()=>setModalMsg("")},"Chiudi")))));}
// EXTERNAL MODULE: ./node_modules/gatsby-plugin-next-seo/lib/index.js
var lib = __webpack_require__(2492);
;// CONCATENATED MODULE: ./src/pages/index.js
const IndexPage=()=>{return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement("main",null,/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement(Helmet.Helmet,null,/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement("meta",{charSet:"utf-8"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement("meta",{name:"description",content:"Brisa Sonora corsi di musica, lezioni di pianoforte, chitarra, violino, sassofono a Catania. associazione musicale."}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement("meta",{name:"google-site-verification",content:"1PIQqEL0OgbiTPjG0fiPZ9rOcO30wM00ZIqtViP6IWo"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement("meta",{name:"keywords",content:"musica lezioni online corsi pianoforte violino sassofono chitarra catania san gregorio strumenti musicali aci sant'antonio paesi etnei valverde aci catena corsi di musica associazione musicale conservatorio"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement("title",null,"Brisa Sonora")),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement(lib.GatsbySeo,{title:"BrisaSonora lezioni di musica",description:"Lezioni di violino e pianoforte online o in sede, per ogni livello ed ogni et\xE0. Impara a suonare con noi!",canonical:"https://brisasonora.it/",openGraph:{url:"https://brisasonora.it",title:"BrisaSonora - Lezioni di musica online e in sede",description:"Lezioni di violino e pianoforte online o in sede, per ogni livello ed ogni età.",images:[{url:logo_brisa/* default */.Z,width:800,height:600,alt:"Logo BrisaSonora"}],locale:"it_IT",language:"it",site_name:"BrisaSonora"},twitter:{handle:"@handle",site:"@brisasonora",cardType:"summary_large_image"}}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement(NavContext/* NavProvider */.N,null,/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement(Navbar/* default */.Z,null),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement(HeroSection,null),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement(MiddleSection,null),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement(TeachersSection,null),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement(FindusSection,null),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement(ContactSection,null),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createElement(Footer/* default */.Z,null)));};/* harmony default export */ const pages = (IndexPage);
...
;// CONCATENATED MODULE: ./src/commons/article/article.js
const Article=({node})=>{var _node$featuredImage,_node$featuredImage$n,_node$featuredImage2,_node$featuredImage2$;return/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("article",{className:"article_container lg:w-1/2 p-5 mt-24"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:`/blog`,style:{display:"flex",color:"black",textDecoration:"none"}},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h3",null,"Indietro"))," ",/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h2",{className:"middle-section__picture__title mb-1 mt-20 lg:mt-0"},node.title),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("h3",{className:"article__date mb-5"},node.date),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("p",{dangerouslySetInnerHTML:{__html:node.content}}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(gatsby_image/* default */.Z,{fixed:(_node$featuredImage=node.featuredImage)===null||_node$featuredImage===void 0?void 0:(_node$featuredImage$n=_node$featuredImage.node)===null||_node$featuredImage$n===void 0?void 0:_node$featuredImage$n.uri,key:(_node$featuredImage2=node.featuredImage)===null||_node$featuredImage2===void 0?void 0:(_node$featuredImage2$=_node$featuredImage2.node)===null||_node$featuredImage2$===void 0?void 0:_node$featuredImage2$.uri,className:"ml-5"}));};/* harmony default export */ const article = (Article);
// EXTERNAL MODULE: ./node_modules/gatsby-plugin-next-seo/lib/index.js
var lib = __webpack_require__(2492);
// EXTERNAL MODULE: ./node_modules/react-helmet/es/Helmet.js
var Helmet = __webpack_require__(4593);
// EXTERNAL MODULE: ./src/context/NavContext.js
var NavContext = __webpack_require__(4763);
;// CONCATENATED MODULE: ./src/templates/blogPost.js
const BlogPostTemplate=({data})=>/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("main",null,/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(Helmet.Helmet,null,/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("meta",{charSet:"utf-8"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("meta",{name:"description",content:data.wpPost.excerpt}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("meta",{name:"google-site-verification",content:"1PIQqEL0OgbiTPjG0fiPZ9rOcO30wM00ZIqtViP6IWo"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("meta",{name:"keywords",content:"musica lezioni online corsi pianoforte violino sassofono chitarra catania san gregorio strumenti musicali aci sant'antonio paesi etnei valverde aci catena corsi di musica associazione musicale conservatorio"}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("title",null,data.wpPost.title)),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(lib.GatsbySeo,{title:data.wpPost.title,description:data.wpPost.excerpt,canonical:"https://brisasonora.it/",openGraph:{url:"https://brisasonora.it",title:data.wpPost.title,description:data.wpPost.excerpt,images:[{url:logo_brisa/* default */.Z,width:800,height:600,alt:"Logo BrisaSonora"}],locale:"it_IT",language:"it",site_name:"BrisaSonora"},twitter:{handle:"@handle",site:"@brisasonora",cardType:"summary_large_image"}}),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(NavContext/* NavProvider */.N,null,/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(Navbar/* default */.Z,null),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("section",{className:"blog w-full h-full  flex items-center justify-between flex-col"},/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(article,{node:data.wpPost})),/*#__PURE__*/external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(Footer/* default */.Z,null)));/* harmony default export */ const blogPost = (BlogPostTemplate);const query="1507259755";
...
var createNamedContext = function createNamedContext(name, defaultValue) {
  var Ctx = (0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.createContext)(defaultValue);
...
var Location = function Location(_ref) {
  ...
  return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(
    LocationContext.Consumer,
    null,
    function (context) {
      return context ? children(context) : external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(
        LocationProvider,
        null,
        children
      );
...
}((external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default()).Component);
    ...
    function (baseContext) {
      return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(
        ...
        function (locationContext) {
          return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(RouterImpl, es_extends({}, baseContext, locationContext, props));
        }
      );
    }
  );
...
var RouterImpl = function (_React$PureComponent) {
  ...
  RouterImpl.prototype.render = function render() {
    ...
    var routes = external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().Children.toArray(children).reduce(function (array, child) {
    ...
    if (match) {
      ...
      var clone = external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().cloneElement(element, props, element.props.children ? external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(
        Router,
      ...
      return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(
        ...
        external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(
          FocusWrapper,
          wrapperProps,
          clone
        )
  ...
  return RouterImpl;
}((external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default()).PureComponent);
...
var FocusHandler = function FocusHandler(_ref3) {
  ...
  return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(
    ...
    function (requestFocus) {
      return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(FocusHandlerImpl, es_extends({}, domProps, {
        component: component,
...
////////////////////////////////////////////////////////////////////////////////
var forwardRef = (external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default()).forwardRef;
    ...
    function (_ref5) {
      ...
      return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(
        ...
        function (_ref6) {
          ...
          return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement("a", es_extends({
            ref: ref || innerRef,
  ...
  return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(
    ...
    function (_ref7) {
      ...
      return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(
        ...
        null,
        function (locationContext) {
          return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().createElement(RedirectImpl, es_extends({}, locationContext, { baseuri: baseuri }, props));
        }
      );
    }
  );
...
var useLocation = function useLocation() {
  var context = (0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useContext)(LocationContext);
...
var useNavigate = function useNavigate() {
  var context = (0,external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_.useContext)(BaseContext);
...
var createRoute = function createRoute(basepath) {
  return function (element) {
    ...
    if (element.type === (external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default()).Fragment && element.props.children) {
      return external_C_Users_Mirko_Documents_brisa_sonora_node_modules_react_index_js_default().Children.map(element.props.children, createRoute(basepath));
    }
...
/* harmony import */ var invariant__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6128);
/* harmony import */ var invariant__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(invariant__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var shallowequal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6774);
...
/* harmony import */ var react_fast_compare__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9590);
/* harmony import */ var react_fast_compare__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_fast_compare__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8237);
...
var React = __webpack_require__(8237);
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("data:image/webp;base64,");
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "static/logocompleto-b71c23deb3e03468c39a6774f4aacd18.webp");
...
"use strict";
module.exports = require("C:\\Users\\Mirko\\Documents\\brisa-sonora\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Users\\Mirko\\Documents\\brisa-sonora\\.cache\\ssr-builtin-trackers\\http");
...
"use strict";
module.exports = require("C:\\Users\\Mirko\\Documents\\brisa-sonora\\.cache\\ssr-builtin-trackers\\https");
...
"use strict";
module.exports = require("C:\\Users\\Mirko\\Documents\\brisa-sonora\\node_modules\\react-dom\\server.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-8606cbcd813f65923884.js"],"app":["/app-0b7c7dea69cda7c27a18.js"],"gatsby-plugin-image":["/gatsby-plugin-image-b42221b8df660d8d0338.js"],"component---src-pages-blog-js":["/component---src-pages-blog-js-c8b173a4c55356a285b7.js"],"component---src-pages-index-js":["/component---src-pages-index-js-1b3af4d12179780cd0ec.js"],"component---src-templates-blog-post-js":["/component---src-templates-blog-post-js-3b59c81aad3c4a82a3f3.js"]}');
...
/* harmony export */ });
const React=__webpack_require__(8237);const path=__webpack_require__(1423);const{renderToString,renderToStaticMarkup,pipeToNodeWritable}=__webpack_require__(7090);const{ServerLocation,Router,isRedirect}=__webpack_require__(3631);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(2031);const fs=__webpack_require__(8709);const{WritableAsPromise}=__webpack_require__(1945);const{RouteAnnouncerProps}=__webpack_require__(5394);const{apiRunner,apiRunnerAsync}=__webpack_require__(9874);const syncRequires=__webpack_require__(885);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(8451);const chunkMapping=__webpack_require__(9804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
