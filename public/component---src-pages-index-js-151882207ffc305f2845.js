  ...
  [678],
  {
    5351: function (e, t, n) {
      ...
      var r = n(7294),
        ...
        o = n(563),
        s = n.n(o),
        l = n.p + "static/violin-ee73e65e293f4e6a0d0be160f4bc071f.webp",
        c = [
          {
            imgSrc:
      ...
      function d() {
        var e = (0, r.useRef)(null),
          t = u.p8.utils.selector(e),
          n = u.p8.timeline({ delay: 1 });
        return (
          (0, r.useEffect)(function () {
            u.p8.to(t(".ond-even"), {
              ...
              u.p8.from(t(".hero-section__list__icon"), {
                opacity: 0,
                x: -1e3,
                stagger: 0.2,
                delay: 1,
          ...
          r.createElement(
            ...
            r.createElement(
              "div",
              { className: "hero-section__main lg:px-20 xl:px-36", ref: e },
              r.createElement(s(), { className: "ondine" }),
              r.createElement("img", {
                src: l,
                alt: "violin",
                "aria-hidden": "true",
              ...
              r.createElement(
                ...
                "Brisa",
                r.createElement("span", null, "Sonora")
              ),
              r.createElement(
                "p",
                { className: "hero-section__subtitle mb-5" },
                "Corsi di musica per tutte le età"
              ),
              r.createElement(
                "ul",
                { className: "hero-section__list mb-20 mt-10" },
                c.map(function (e) {
                  var t = e.imgSrc,
                    n = e.title,
                    a = e.alt;
                  return r.createElement(
                    ...
                    r.createElement(
                      "span",
                      { className: "hero-section__list__instr" },
                      " ",
                      n
                    )
                  );
              ...
              r.createElement(
                ...
                r.createElement(
                  "button",
                  { className: "hero-section__ctas__find-us ml-20" },
                  r.createElement("a", { href: "#findus" }, "Vieni a trovarci")
                )
              )
            )
          )
        ...
        return (
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement("h1", { className: "title mb-20" }, "La scuola "),
              m.map(function (e, t) {
                return r.createElement(
                  "div",
                  {
      ...
      var v,
        p = n.p + "static/anninaPng-0274424aefcab1a6ed9bf3a4647675b7.webp",
        A = n.p + "static/lauraPng-4b7d39aa6f51412ea583ab12433d2efa.webp",
        y = n.p + "static/pianoPng-efe16aeb6bf8a4b087af39e1835417f3.webp",
        k = n.p + "static/saxPng-c9433b3912b370df537c441faa01be85.webp",
      ...
      function w(e) {
        var t = e.index,
          ...
          c = l[0],
          u = l[1],
          d = Math.round(250 / Math.tan(Math.PI / N.length)),
          m = 360 / N.length,
          f = function (e) {
            clearInterval(a), u({ x: e.clientX, y: e.clientY });
          },
          h = function (e, r) {
            e.clientX - c.x > 100
              ? n(t - 1)
      ...
      function E() {
        var e,
          ...
          i = n[1],
          o = (0, r.useRef)(null),
          s = u.p8.utils.selector(o);
        return (
          (0, r.useEffect)(function () {
            v = setInterval(function () {
              i(function (e) {
                return e < c.length - 1 ? e + 1 : 0;
              });
            }, 5e3);
          }, []),
          (0, r.useEffect)(function () {
            u.p8
              ...
              .from(s("img"), { xPercent: -50, opacity: 0, stagger: 0.1 }, 0)
              .from(s("p"), { xPercent: 50, opacity: 0, stagger: 0.1 }, 0);
          }, []),
          r.createElement(
            "section",
            {
            ...
            r.createElement(
              ...
              null === (e = N[Math.abs(a) % N.length]) || void 0 === e
                ? void 0
                : e.name
            ),
            r.createElement(
              ...
              r.createElement(w, { index: a, setIndex: i, interval: v }),
              r.createElement(
                "div",
                { className: "flex space-between" },
                r.createElement("div", { className: "w-1/2 h-1/2" }),
                r.createElement(
                  "div",
                  ...
                  r.createElement(
                    ...
                    null === (t = N[Math.abs(a) % N.length]) || void 0 === t
                      ? void 0
                      : t.bio
                  )
                )
        ...
        return (
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement("h1", { className: "title" }, "Dove ci troviamo"),
              r.createElement(
                "address",
                { className: "pt-5 pl-2 mb-10" },
                "La nostra sede è in Via Tenente Garozzo, 2 95025",
                r.createElement("p", null, "Aci Sant'Antonio (CT)")
              )
            ),
            r.createElement(
              "div",
      ...
      var x = function () {
          var e = r.useState(window && window.innerWidth > 600),
            t = e[0],
            n = e[1];
          return r.createElement(
            "nav",
            {
              className:
                "navbar flex fixed items-center justify-end flex-wrap w-screen px-10 lg:px-60 xl:px-96 py-8",
            },
            r.createElement(
              "div",
              { className: "flex align-center lg:hidden" },
              r.createElement(
                "button",
                {
                  className: "mr-10 w-0",
                ...
                r.createElement(
                  ...
                  r.createElement(
                    ...
                    r.createElement(
                      ...
                      r.createElement("span", { className: "burger-bun-top" }),
                      r.createElement("span", { className: "burger-filling" }),
                      r.createElement("span", { className: "burger-bun-bot" })
                    )
                  ),
                  r.createElement(
                    "div",
                    { className: "path-burger" },
                    r.createElement("div", { className: "animate-path" })
                  )
                )
              )
            ),
            r.createElement(
              ...
              (t || (window && window.innerWidth > 600)) &&
                r.createElement(
                  "div",
                  {
                    className:
                      "flex flex-col lg:flex-row flexitems-center mt-5 lg:mt-0 justify-between lg:flex-grow w-full",
                  },
                  r.createElement(
                    "a",
                    {
        ...
        B = n.p + "static/logocompleto-083906e5e42a55fc702fda693f218bf2.webp",
        V = function () {
          return r.createElement(
            "footer",
            {
            ...
            r.createElement(
              "div",
              { className: "footer__section mt-10 md:mt-0" },
              "Developed by",
              r.createElement(
                "a",
      ...
      function S() {
        var e = (0, r.useRef)(),
          ...
          o = i[0],
          s = i[1],
          l = "https://wa.me/+393473208541/?text=" + o,
          c = u.p8.utils.selector(e);
        return (
          (0, r.useEffect)(function () {
            u.p8
              .timeline({
              ...
              .from(
                c(".contact-section__form__title"),
          ...
          r.createElement(
            ...
            r.createElement("h1", { className: "title" }, "Contattaci"),
            r.createElement(
              "div",
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    "a",
                    { href: l, className: "hero-section__ctas__contact" },
                    "Invia"
                  )
                )
              ),
              r.createElement(
                ...
                r.createElement(
                  "a",
                  { href: "mailto:" + L, className: "phone_number" },
                  L
                )
              )
            )
      ...
      var W = function () {
        return r.createElement(
          "main",
          null,
          r.createElement("title", null, "Home Page"),
...
//# sourceMappingURL=component---src-pages-index-js-151882207ffc305f2845.js.map
